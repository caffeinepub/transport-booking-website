...
import type { BookingDetails as _BookingDetails, BookingId as _BookingId, BookingRecord as _BookingRecord, BookingStatus as _BookingStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllBookingsForAdmin(): Promise<Array<BookingRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBookingsForAdmin();
    ...
    async getBookingStatusById(arg0: BookingId): Promise<BookingStatus | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingStatusById(arg0);
    ...
    async getBookingsByPhone(arg0: string): Promise<Array<BookingRecord>> {
        if (this.processError) {
            try {
    ...
    async getUserIdByName(arg0: string): Promise<Principal | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserIdByName(arg0);
    ...
    async submitBooking(arg0: BookingDetails): Promise<BookingId> {
        if (this.processError) {
            try {
...
function from_candid_BookingRecord_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BookingRecord): BookingRecord {
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BookingStatus]): BookingStatus | null {
    return value.length === 0 ? null : from_candid_BookingStatus_n6(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BookingRecord>): Array<BookingRecord> {
    return value.map((x)=>from_candid_BookingRecord_n4(_uploadFile, _downloadFile, x));
}
